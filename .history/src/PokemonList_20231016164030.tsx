...
const PokemonList = () => {
  ...
  // filteredData?.map((it: any) =>
  //   console.log(it.abilities[0].ability.name, "<==it.ability")
  // );

  // filteredData?.map((it: any) =>
  //   console.log(it.types[0].type.name, "<==it.ability")
  // );
  filteredData?.map((it: any) => console.log(it, "<==it"));
                ...
                onClick={() =>
                  navigate(item.name, {
                    state: {
                      ...
                      height: item.height,
                      weight: item.weight,
                      abilities: item.abilities[0].ability.name,
                      front_default: item.sprites.front_default,
                      back_default: item.sprites.front_default,

                      back_female: item.sprites.front_female,
                      back_shiny: item.sprites.front_shiny,
                      back_shiny_female: item.sprites.front_shiny_female,
                    },
                  })
                }
                key={`list_${index}`}
